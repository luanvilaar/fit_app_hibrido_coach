-- Reverte 20260813130000_prescription_reference_kind.sql: remove 'reference' da constraint e
-- volta insert_template_blocks a só pular séries para 'qualitative'.
